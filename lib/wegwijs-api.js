 ...
 * @template T
 * @param {Array<T>} array - The array to search in
 ...
 * @param {string | undefined} wegwijsChangeTime - The change time of the Wegwijs data
 * @param {string | undefined} abbChangeTime - The change time of the ABB data
...
export const isUpdateNeeded = (wegwijsChangeTime, abbChangeTime) => {
  return wegwijsChangeTime && abbChangeTime
    ? new Date(wegwijsChangeTime) > new Date(abbChangeTime)
    : true;
};
